...
STATE="MTY"
LOCALITY="Monterrey"
ORGANIZATION_NAME="Digital on US by TechMahindra"
root_ca_password="tigerfis"
key_bits_length="4096"
days_till_expire=365
ca_chain_prefix="fis.chain.ca"
intermediate_ca_dir="."
openssl_root_config_file="./openssl_root_ca.cnf"
openssl_intermediate_config_file="./openssl_device_intermediate_ca.cnf"
intermediate_ca_password="tigerfis"
root_ca_prefix="fis.root.ca"
intermediate_ca_prefix="fis.intermediate"
...
function generate_device_certificate_common()
{
    ...
    local ca_password="${4}"
    local server_pfx_password="tigerfis"

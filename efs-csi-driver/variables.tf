...
variable "cluster_identity_oidc_issuer" {
  ...
  default = "https://oidc.eks.ca-central-1.amazonaws.com/id/5DAE650048225F1544D2E295014E4C53"
}

variable "cluster_identity_oidc_issuer_arn" {
  type        = string
  description = "The OIDC Identity issuer ARN for the cluster that can be used to associate IAM roles with a service account."
  default = "arn:aws:iam::520983883852:oidc-provider/oidc.eks.ca-central-1.amazonaws.com/id/5DAE650048225F1544D2E295014E4C53"
}

...
namespace Consoto.AdtFunctions
{
    public static class TelemetryFunction
    {
        ...
        public static async Task Run(
            [EventHubTrigger("fis-digitaltwins-eventub", Connection = "ADT_HUB_CONNECTIONSTRING")] EventData[] events,
            [EventHub("fis-tsi-eventub", Connection = "TSI_HUB_CONNECTIONSTRING")] IAsyncCollector<string> outputEvents,
            ILogger log)
        {

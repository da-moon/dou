...
def saveDataToDigitalTwin(event_id, msg):
    ...
    if digital_twin:
        ...
        body["Schedule_Is_Productive"] = 1

        body["timestamp"] = int(body["timestamp"]) / 1000
...
def transformData(jsonBody):
    ...
    if "State_Code" in jsonBody:
        ...
        dict["stateNetAvailable"] = True if dict["stateNonProd"] == True else True if jsonBody["Schedule_Is_Productive"] == 1 else False

...
func TestTerraformSsh(t *testing.T) {
	...
	exampleFolder := test_structure.CopyTerraformFolderToTemp(t, "../", "examples/terraform_aws_ssh/")
...
func testSSHToPublicHost(t *testing.T, terraformOptions *terraform.Options, keyPair *aws.Ec2Keypair) {
	...
	publicInstanceIP := terraform.Output(t, terraformOptions, "consul_instance_ip")

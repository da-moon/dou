...
variable "start_fsc" {
  description = "Indicates if FSC process should be started in this machine"
  default     = false
}

variable "start_pool_mgr" {
  description = "Indicates if pool manager process should be started in this machine"
  default     = false
}

...
variable "ms_subnet_segment_start" {
...
variable "manager_base_ami_id" {
  description = "Base AMI to use for manager nodes"
}

variable "worker_base_ami_id" {
  description = "Base AMI to use for worker nodes"
}

variable "target_group" {
  description = "Target group for registering swarm cluster nodes to ALB"
}

variable "route_tables" {
  description = "Route table ids to use for microservice subnets"
  type        = list(string)
}

...
if [ "$INSTALLATION_PREFIX" != "" ] ; then KEY=tfstates/$INSTALLATION_PREFIX/tc/${ENV_NAME}/bake_aw_client_builder ; else KEY=tfstates/tc/${ENV_NAME}/bake_aw_client_builder ; fi

#!/usr/bin/env python3
"""
Vagrant external inventories script. Automatically finds the IP of the booted vagrant vm(s), and
returns it under the host group 'vagrant'
Example Vagrant configuration using this script:
    config.vm.provision :ansible do |ansible|
      ansible.playbook = "./provision/your_playbook.yml"
      ansible.inventory_file = "./provision/inventories/vagrant.py"
...
#
# Thanks to the spacewalk.py inventories script for giving me the basic structure
# of this.
#

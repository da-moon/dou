...
if [ "$INSTALLATION_PREFIX" != "" ] ; then KEY=tfstates/$INSTALLATION_PREFIX/tc/${ENV_NAME}/build_server ; else KEY=tfstates/tc/${ENV_NAME}/build_server ; fi
if [ "$DELETE_DATA" != "" ] ; then DELETE=-var="delete_db_data=$DELETE_DATA" ; fi

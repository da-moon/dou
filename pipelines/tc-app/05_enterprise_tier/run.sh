...
if [ "$INSTALLATION_PREFIX" != "" ] ; then KEY=tfstates/$INSTALLATION_PREFIX/tc/${ENV_NAME}/bake_enterprise_server ; else KEY=tfstates/tc/${ENV_NAME}/bake_enterprise_server ; fi
